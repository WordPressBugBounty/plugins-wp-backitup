...
* UPDATE : Major update to address technical debt in plugin

= 1.50 =
*Release Date -  March 15, 2024

* UPDATE : Updates to add randomized log file suffix
* UPDATE : Updates to log file collection
* UPDATE : Misc minor fixes

= 1.45 =
*Release Date -  December 23, 2023

* UPDATE : Updates to support WordPress 6.4 Enhancements
* UPDATE: Escaped reserved 'offset' keyword to fix the mariadb version > 10.6 conflict
* UPDATE: php deprecated function fix

= 1.43 =
*Release Date -  August 12, 2022

* UPDATE : Updates to support WordPress 6.0 Enhancements

= 1.42 =
*Release Date -  March 24, 2022

* UPDATE : Updates to support WordPress 5.9 Enhancements


= 1.41 =
*Release Date -  September 06, 2021

* UPDATE : Updates to support WordPress 5.8 Enhancements

= 1.40 =
*Release Date -  December 10, 2020

* FIX : Updated tested up to settings

= 1.39 =
*Release Date -  December 10, 2020

* UPDATE : Updates to support WordPress 5.6 Enhancements
* FIX    : Review reminder does not close so removed

= 1.38 =
*Release Date -  June 2, 2020

* UPDATE : Updates to support WordPress 5.4
