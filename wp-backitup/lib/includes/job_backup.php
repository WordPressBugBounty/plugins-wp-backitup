...
function getStatusLog(){
	...
	$status_file_path = WPBACKITUP__PLUGIN_PATH .'logs/'.$log_file_name;
	//error_log($status_file_path);
...
function get_response_file() {
    ...
    $response_file_path = WPBACKITUP__PLUGIN_PATH .'logs/'.$log_file_name;
	//error_log('response_log:'.$response_file_path);
